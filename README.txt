...
To run Hexoshi with a particular Python version, open hexoshi.py and
change the shebang on line one to indicate the version you want to use,
e.g. S"python2" or "python3" instead of just "python".
